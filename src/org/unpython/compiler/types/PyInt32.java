...
public class PyInt32 extends PyType {
    
    @Override
    public PyType ladd(PyType rhs){
        if(rhs instanceof PyInt32) return new PyInt32();
    ...
    public boolean equals(Object rhs){
        if(rhs instanceof PyInt32) return true;
        return false;
    }
    ...
    public PyType compareLt(PyType t){
        ...
        if(t instanceof PyInt32) return new PyInt32();
