...
public class PyFloat64 extends PyType {

    @Override
    public PyType ladd(PyType obj) {
        if ((obj instanceof PyInt32) || (obj instanceof PyInt64) || (obj instanceof PyFloat32) || (obj instanceof PyFloat64)) {
    ...
    public boolean canAssign(PyType t){
        ...
        if(t instanceof PyInt32) return true;
		if(t instanceof PyFloat64) return true;
        return false;
    }

    @Override
    public PyType compareLt(PyType t){
        if(t instanceof PyFloat32) return new PyInt32();
        if(t instanceof PyInt64) return new PyInt32();
        if(t instanceof PyFloat64) return new PyInt32();
        return null;
    }
