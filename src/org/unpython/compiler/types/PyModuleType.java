...
import org.unpython.compiler.PyUtils;

public class PyModuleType extends PyType{
    private String name;
    public PyModuleType(String name){
        this.name = name;
    }
    ...
    @Override
    public boolean hasAttr(String aname){
        return PyUtils.hasAttr(name,aname);
        
    }
    
    @Override
    public PyType getAttr(String aname){
        return PyUtils.getAttr(name, aname);
    }
}
